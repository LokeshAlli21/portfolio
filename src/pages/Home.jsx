...
const Home = () => {
  ...
  const stats = [
    ...
    { label: "Technologies Mastered", value: "15+", icon: Zap, color: "text-purple-400" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className={`max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          {/* Profile Image */}
          <div className="mb-8">
            <div className="w-40 h-40 mx-auto mb-6 rounded-full bg-gradient-to-r from-purple-400 via-pink-400 to-purple-600 p-1 shadow-2xl transform hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto mb-8 leading-relaxed">
              Passionate Full Stack Developer from Solapur, specializing in <span className="text-purple-400">MERN stack</span> and <span className="text-pink-400">real estate technology</span>. 
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            ...
            <div className="flex items-center gap-2 text-gray-300 hover:text-purple-400 transition-colors">
              ...
              <a href="mailto:lokeshalli1807@gmail.com" className="hover:text-purple-400 transition-colors">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <a 
              ...
              className="group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group border border-purple-400 hover:bg-purple-400 hover:text-slate-900 px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
            >
              ...
              <div key={category} className="group p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="flex flex-wrap gap-2">
                  {data.skills.map((skill, index) => (
                    <span key={index} className="px-3 py-1 text-sm bg-purple-500/20 text-purple-300 rounded-full border border-purple-500/30 hover:bg-purple-500/30 transition-colors">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            {projects.map((project, index) => (
              <div key={index} className="group p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-white group-hover:text-purple-400 transition-colors mb-1">
                      {project.title}
                    </h3>
          ...
          <div className="space-y-8">
            ...
            <div className="group p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-purple-400 font-semibold">2019 - 2022</span>
              </div>
              <p className="text-gray-400 text-sm">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-105">
              <Rocket className="w-12 h-12 text-purple-400 mx-auto mb-4 group-hover:scale-110 transition-transform" />
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="p-8 rounded-2xl bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-purple-500/10 backdrop-blur-sm border border-purple-500/20">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <a 
                ...
                className="group bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group border border-purple-400 hover:bg-purple-400 hover:text-slate-900 px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2 shadow-lg"
              >
                <Github className="w-5 h-5 group-hover:rotate-12 transition-transform" />
                View My Work
              </a>
            ...
            <div className="flex justify-center gap-6 text-gray-400">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-400">Quality</div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-white/5 hover:bg-white/10 transition-colors border border-white/10 hover:border-purple-400/50"
              >
